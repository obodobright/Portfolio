...
export const workData = [
  ...
  },
  {
    ...
    title: "Sport-Statix",
    description:
      "The ultimate sports management platform dedicated to bringing African sports together.",
    stack: [
      {
        icon: <FaReact />,
        tooltip: "React",
  ...
  },
  {
    ...
    title: "Riby Hr",
    description:
      "RibyHr is a dedicated Hr platform where jobs can be posted by the dedicated staff and be seen in job market place and Riby website",
    stack: [
      {
        icon: <FaReact />,
        tooltip: "React",
